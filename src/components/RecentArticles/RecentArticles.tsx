    ...
    <div className="w-full flex items-center justify-center py-10">
      <div className="w-[90%] flex flex-wrap justify-between gap-5">
        ...
        <div className="w-[48%] flex flex-col">
          <div className="w-full h-[400px] border border-r-6 border-b-6 rounded-tr-xl rounded-bl-xl overflow-hidden relative">
            <img
            ...
            <div className="absolute bottom-0 left-0 w-full flex items-center justify-center">
              <div className="w-[95%] left-4 bg-white border border-r-5 border-b-5 px-2   flex items-center gap-1 my-3 p-2">
                <h3 className="text-4xl font-bold hover:underline hover:text-red-500 transition-all duration-700 ease-in-out cursor-pointer">
                  It's Great The Government Is Tightening Gambling Rules
                </h3>
              </div>
            </div>
          </div>
